...
namespace kiwi
{
    namespace engine
    {
        ...
        class Instance : public core::Beacon::Factory
        {
        public: // methods
            ...
            void addConsoleListener(core::Console::Listener& listener);
            
            //! @brief Removes a console listener.
            void removeConsoleListener(core::Console::Listener& listener);
